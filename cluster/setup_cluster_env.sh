...
echo "  cd ${REPO_ROOT}"
echo "  NODES_CSV=pipeline/outputs/entities.parquet \\"
echo "  EDGES_CSV=pipeline/outputs/relations.parquet \\"
echo "  METADATA_CSV=pipeline/outputs/metadata_parsed.parquet \\"
